      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 py-16">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 bg-[#CCFBF1] text-[#0D9488] px-3.5 py-1.5 rounded-full text-xs font-semibold mb-4">
            Transparent Healthcare Plans
          </div>
          <h1 className="text-4xl font-extrabold text-[#1E3A5F] mb-4">Affordable Health for Every Nigerian</h1>
          <p className="text-lg text-gray-600">Choose the plan that best fits your healthcare needs. Transparent pricing, zero hidden fees.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm flex flex-col justify-between">
            ...
            <Link
              ...
              className="w-full py-3 rounded-xl border-2 border-gray-200 text-gray-700 font-bold hover:bg-gray-50 transition-colors text-center block"
            >
              {isAuthenticated ? "Active on Your Account" : "Get Started Free"}
            </Link>
          </div>

          {/* Plus Plan */}
          <div className="bg-[#1E3A5F] rounded-3xl p-8 border border-[#1E3A5F] shadow-xl relative transform md:-translate-y-4 flex flex-col justify-between">
            <div>
            ...
            <Link
              href={isAuthenticated ? "/consultations/checkout/dr-1" : "/signup"}
              className="w-full py-3 rounded-xl bg-[#0D9488] text-white font-bold hover:bg-[#0f766e] transition-colors shadow-md text-center block"
            >
          ...
          {/* Enterprise */}
          <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm md:col-span-2 lg:col-span-1 flex flex-col justify-between">
            <div>
            ...
            <Link
              href="/contact"
              className="w-full py-3 rounded-xl border-2 border-[#1E3A5F] text-[#1E3A5F] font-bold hover:bg-gray-50 transition-colors text-center block"
            >
              Contact Sales
            </Link>
          </div>
