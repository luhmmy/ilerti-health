...
export default function SecretInsightsPage() {
  return (
    <div>
      <div className="mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-[#1E3A5F]">Public Health Insights</h1>
          <p className="text-gray-600 mt-2">Disease surveillance and population health patterns across Nigeria.</p>
        </div>
        <button className="bg-white border border-gray-200 text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center gap-2 text-sm shadow-xs">
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-8">
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <select className="bg-gray-50 border border-gray-200 rounded-lg px-3 py-1.5 text-sm">
              <option>All Nigerian Regions</option>
              <option>South West (Lagos, Oyo, Ogun)</option>
              <option>North Central (Abuja FCT, Plateau)</option>
              <option>South South (Rivers, Delta)</option>
            </select>
          </div>
          <div className="h-64 bg-gray-50 rounded-xl flex items-center justify-center border border-dashed border-gray-200">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">Real-time Triage Analytics: Malaria vs Typhoid Trendlines</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-bold text-gray-900 mb-6 flex items-center gap-2">
            <Map className="w-5 h-5 text-[#0D9488]" /> Regional Outbreak Alerts
          </h2>
