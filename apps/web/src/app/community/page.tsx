  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center max-w-3xl mx-auto mb-12">
        <h1 className="text-4xl font-bold text-[#1E3A5F] mb-4">ILERTI Community Outreach</h1>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        {events.map(event => (
          <div key={event.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:shadow-md transition-shadow">
            ...
            <button className="w-full py-2.5 bg-[#0D9488] text-white rounded-lg font-medium hover:bg-[#0f766e] transition-colors">
              Register to Attend
            </button>
          </div>
        ))}
      ...
      <div className="mt-16 bg-[#1E3A5F] rounded-3xl p-8 md:p-12 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="px-6 py-3 bg-white text-[#1E3A5F] font-bold rounded-lg hover:bg-gray-100 transition-colors">
            Become a Partner
          </button>
